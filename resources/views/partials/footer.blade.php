                        ...
                        <div class="single-tweet-text">
                            <div class="twt-text">
                                ...
                                <p>Mirum est notare quam littera gothica <a
                                        href="https://twitter.com/beforwardzimbabwe">”@ quam nunc putamus parum
                ...
                <div class="col-lg-7 col-xl-6 col-md-8">
                    <div class="footer-links-copyright">
                        ...
                        <div class="social-links">
                            ...
                            <a href="https://twitter.com/beforwardzimbabwe"><i class="fa fa-twitter"></i></a>
                            <a href="https://www.behance.net/beforwardzimbabwe"><i class="fa fa-behance"></i></a>
                            <a href="https://dribbble.com/beforwardzimbabwe"><i class="fa fa-dribbble"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-xl-6 col-md-4">
                    <div class="payment-img">
                        <img src="{{asset('assets/img/other/payment.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
